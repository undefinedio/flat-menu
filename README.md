...
Note that previous versions of the Boilerplate did not include `Flat_Menu_Loader` but this class is used to register all filters and actions with WordPress.
